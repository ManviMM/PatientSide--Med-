...
public class UpiPaymentGateway extends AppCompatActivity {
    ...
    EditText editTxtUpiId, editTxtNote;
    Button btnUpiSend;
    TextView editTxtAmount , editTxtNameOfHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTxtNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //dialog box for timings preferred
            }
        });
    ...
    void intializeViews() {
        ...
        //receiving the names from details class
        Intent i = getIntent();
        String name = i.getStringExtra("name");
        editTxtNameOfHolder = findViewById(R.id.editTxtNameOfHolder);
        editTxtNameOfHolder.setText(name);
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(UpiPaymentGateway.this)) {
            ...
            if (status.equals("success")) {
               ...
               /*//Name of doctor
                Log.e("Name ", "of Doctor :",+ editTxtNameOfHolder );

                Handler handler=new Handler();
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent=new Intent(UpiPaymentGateway.this, ThankyouPage.class);
                        startActivity(intent);
                        finish();
                    }
                },5000);*/
